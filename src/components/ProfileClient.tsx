...
import { Curug, Review } from "@prisma/client";
        ...
        <Card className="mb-8 bg-blue-50 border-blue-200">
          <CardBody>
            <div className="flex items-center justify-between">
              <div>
                <h3 className="font-semibold text-lg">Akses Admin</h3>
                <p className="text-sm text-gray-600">
                  Anda memiliki hak akses sebagai administrator.
                </p>
              </div>
